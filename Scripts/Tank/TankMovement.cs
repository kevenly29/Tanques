...
public class TankMovement : MonoBehaviour
{
 ...
 public AudioClip m_EngineIdling; // Audio a reproducir c    uando el tanque no se mueve.
 public AudioClip m_EngineDriving; // Audio a reproducir c  uando el tanque se está moviendo.
 public float m_PitchRange = 0.2f; // Cantidad de variació    n de afinación del audio del motor(para que sea más real).
 ...
 private Rigidbody m_Rigidbody; // Referencia del compo  nente para mover el tanque.
 private float m_MovementInputValue; // Valor actual de entr  ada para el movimiento.
